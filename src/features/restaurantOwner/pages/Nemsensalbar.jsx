          ...
          <div className="grid grid-cols-4 gap-8">
            ...
            <div className="col-span-3">
              <div className="grid grid-cols-2 gap-6">
                ...
                {/* Branch Location */}
                <div>
                  <label className="text-gray-400 text-sm mb-2 block">Дүүрэг сонгох</label>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="text-white text-sm hover:bg-[#1E2530] transition-colors">
                  ...
                  <td className="px-4 text-gray-400">WYF3+GV8 And Ayush Ave BGD - 13 Ulaanbaatar 16091</td>
